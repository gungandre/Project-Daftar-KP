                                ...
                                @foreach ($absens as $absen)
                                    @forelse ($absen->Absensi as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->tanggal }}</td>
                                            <td> <span
                                                    class="badge @if ($data->kehadiran == 'approve') bg-success @else bg-danger @endif">{{ $data->kehadiran }}</span>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="{{ route('kegiatan-magang.edit', $data->tanggal) }}"><i
                                                                class="bx bx-edit-alt me-1"></i>Edit</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('kegiatan-magang.show', $data->tanggal) }}">
