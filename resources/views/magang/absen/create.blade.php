...
<div class="card p-4">
    ...
    <form class="form-control"  action="{{route('userData.store')}}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <!-- Email input -->
        <div class="form-outline mb-4">
          <input type="date" id="form6Example5" class="form-control" name="tanggal"/>
          <label class="form-label" for="form6Example5">Tanggal Absen</label>
        </div>
